...
import $ from './index.articles.module.scss'
      ...
      <div>
        <article>
          ...
          <p className={$.paragraph}>
            ...
            backend, but with a wide spectrum that reads people’s emotion and
            the future. Both developers and designers should not be biased to
            their own job. If you focus only one thing, you’ll never see the
            other side. We need harmony. We need to cross the boundary between
            totally different areas.
          </p>
          <p className={$.paragraph}>
            Look around you. Literally, everything is designed. A typography,
            the font you’re looking at right now is also a design. Products and
